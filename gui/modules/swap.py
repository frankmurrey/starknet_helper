...
class SwapFrame(customtkinter.CTkFrame):
    def __init__(self, master, grid, **kwargs):
        ...
        self.protocol_combo.grid(row=1, column=0, padx=20, pady=0, sticky="w")

        self.coin_to_swap_label = customtkinter.CTkLabel(
            self.frame, text="Coin to swap:"
        )
        self.coin_to_swap_label.grid(row=2, column=0, padx=20, pady=(10, 0), sticky="w")
        ...
        self.coin_to_swap_combo.grid(row=3, column=0, padx=20, pady=0, sticky="w")

        self.coin_to_receive_label = customtkinter.CTkLabel(
            self.frame, text="Coin to receive:"
        )
        self.coin_to_receive_label.grid(
            row=2, column=1, padx=20, pady=(10, 0), sticky="w"
        )

        self.coin_to_receive_combo = customtkinter.CTkComboBox(
            self.frame, width=120, values=self.coin_to_receive_options
        )
