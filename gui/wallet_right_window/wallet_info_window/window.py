...
from gui.wallet_right_window.wallet_info_window.scrollable_frame import WalletInfoScrollableFrame
from gui.wallet_right_window.wallet_info_window.table_top import WalletInfoTopFrame
...
if TYPE_CHECKING:
    from gui.wallet_right_window.wallet_item import WalletsTable
...
class WalletInfoWindow(customtkinter.CTkToplevel):
    def __init__(self, master, wallet_data: WalletData):
        ...
        test_task = tasks.UnframedCancelOrdersTask(
            wait_for_receipt=True,
            test_mode=True,
            result_info="glashaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa",

        )
        self.scrollable_frame.draw_frame(tasks=self.info_items)
        # self.scrollable_frame.draw_frame(tasks=[test_task, test_task])
